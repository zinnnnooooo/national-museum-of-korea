...
const products = [
  {
    id: 'golden-pen-set',
    name: 'Heritage Golden Ornament Pen Set',
    category: 'living treasures',
    desc: 'Traditional gold-adorned brass pen set inspired by royal Joseon stationery.',
    price: '₩ 125,000',
    src: 'design/good_1.png'
  },
  {
    id: 'pattern-goods-set',
    name: 'Traditional Pattern Heritage Accessory Set',
    category: 'living fashion',
    desc: 'Exquisite luxury gift set decorated with timeless Korean geometric motifs.',
    price: '₩ 210,000',
    src: 'design/good_2.png'
  },
  {
    id: 'embroidery-keyring-set',
    name: 'Heritage Embroidered Keyring Set',
    category: 'fashion treasures',
    desc: 'Delicately hand-embroidered traditional keyrings adorned with silk tassels.',
    price: '₩ 85,000',
    src: 'design/good_3.png'
  },
  {
    id: 'cultural-heritage-set',
    name: 'Korean Cultural Heritage Design Collection',
    category: 'living treasures',
    desc: 'Curated museum edition design collection celebrating iconic cultural heritage.',
    price: '₩ 290,000',
    src: 'design/good_4.png'
  },
  {
    id: 'pattern-wireless-charger',
    name: 'Traditional Pattern Wireless Charger',
    category: 'living',
    desc: 'Modern fast wireless charger patterned with traditional royal heritage motifs.',
    price: '₩ 115,000',
    src: 'design/good_5.png'
  },
  {
    id: 'moon-jar',
